            ...
            <div class="container">
                <div class="collapse navbar-collapse">
                    ...
                    <ul class="navbar-nav ml-auto justify-content-end text-right header-user-bar">
                        <li><a data-toggle="tooltip" data-title="mesajlar" data-placement="bottom" href="#" data-original-title="" title="">
                            <i class="icon-envelope"></i>
                        </a></li>
                        <li>
                            <div class="dropdown">
                                <span class="notification-count">1</span>
                                <a class="dropdown-toggle" role="button" id="notificationList" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#">
                                    <i class="icon-bell"></i>
                                </a>
                        ...
                        <li>
                            <div class="dropdown">
                                <a class="dropdown-toggle" role="button" id="onlineList" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#">
                        ...
                        <li>
                            <div class="dropdown">
                                <a class="dropdown-toggle" role="button" id="userMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#">
                                    <i class="icon-user"></i>
                                </a>
